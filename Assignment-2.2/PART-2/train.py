...
class Neural_Network(Module):
	...
	def __init__(self):
		...
		L9=Conv2d(64,512,3,1)
		L10=BatchNorm2d(512)
		L11=ReLU(inplace=True)
		L12=MaxPool2d(2,stride=2)
		L13=Conv2d(512,1024,2,1)
		...
		self.Linear1=Linear(1*1*1024,256)
...
def main():
	# train_data="/content/drive/MyDrive/ASS2.2.2/train_data.csv"
